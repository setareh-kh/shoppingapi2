...
namespace shoppingapi2.Migrations
{
    ...
    [Migration("20240328080917_addOrderDetailsentity")]
    partial class addOrderDetailsentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("shoppingapi2.Models.OrderDetails", b =>
                {
                    b.HasOne("shoppingapi2.Models.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("shoppingapi2.Models.Product", "Product")
                        .WithMany()
